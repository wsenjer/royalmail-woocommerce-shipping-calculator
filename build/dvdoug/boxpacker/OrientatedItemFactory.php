 ...
 * @author Doug Wright
 */
namespace WPRubyRoyalMail\Build\DVDoug\BoxPacker;

use WPRubyRoyalMail\Build\Psr\Log\LoggerAwareInterface;
use WPRubyRoyalMail\Build\Psr\Log\LoggerAwareTrait;
use WPRubyRoyalMail\Build\Psr\Log\NullLogger;
/**
...
class OrientatedItemFactory implements LoggerAwareInterface
{
     ...
     */
    public function getBestOrientation(Item $item, OrientatedItem $prevItem = null, ItemList $nextItems, $widthLeft, $lengthLeft, $depthLeft, $rowLength, $x, $y, $z, PackedItemList $prevPackedItemList)
    {
        $this->logger->debug("evaluating item {$item->getDescription()} for fit", ['item' => $item, 'space' => ['widthLeft' => $widthLeft, 'lengthLeft' => $lengthLeft, 'depthLeft' => $depthLeft]]);
     ...
     */
    public function getPossibleOrientations(Item $item, OrientatedItem $prevItem = null, $widthLeft, $lengthLeft, $depthLeft, $x, $y, $z, PackedItemList $prevPackedItemList)
    {
     ...
     * @return OrientatedItem[]
     */
    protected function getUsableOrientations(Item $item, array $possibleOrientations)
    {
